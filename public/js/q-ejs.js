...
questionArr[++i] = {
    id: i,
    text: 'Öyle insanlar vardır ki çok iyi eğitim almalarına rağmen Türk dilinin kırlarında kör topal yürüyen insan olmaktan kurtulamazlar. <br aria-hidden="true"><strong>Yukarıdaki cümlede geçen “dilin kırlarında kör topal yürümek" sözüyle anlatılmak istenen aşağıdakilerden hangisidir?</strong>' ,
    ...
    answer: undefined,
    marked: false,
    qAudioSrc: '/test/audio/q1.mp3',
    oAudioSrc: '/test/audio/o1.mp3'
};
questionArr[++i] = {
    id: i,
    text: 'Dostoyevski doğduğu günden ölüm anına kadar sürekli acının potasında yoğrulmuş bir yazardı. <br aria-hidden="true"><strong>Bu cümledeki “acının potasında yoğrulmak” sözüyle anlatılmak istenen aşağıdakilerden hangisidir?</strong>' ,
    ...
    answer: undefined,
    marked: false,
    qAudioSrc: 'audio/q2.mp3',
    oAudioSrc: 'audio/o2.mp3'
};
questionArr[++i] = {
    id: i,
